#!/usr/bin/env python3
"""
Encode WAV file to AAC ADTS.

This sample encodes a WAV audio file to AAC ADTS format using AVBlocks.
"""
...
def main(input_file: str, output_file: str):
    ...
    if not input_file or not output_file:
        ...
        if not output_file:
            output_file = os.path.join(script_dir, "../output/enc_aac_adts_file/Hydrate-Kenny_Beltrey.aac")
