#!/usr/bin/env python3
"""
Decode Vorbis/OGG file to WAV.

This sample decodes a Vorbis/OGG audio file to a WAV file using AVBlocks.
"""
...
def main(input_file: str, output_file: str):
    ...
    if not input_file or not output_file:
        ...
        if not output_file:
            output_file = os.path.join(script_dir, "../../output/dec_vorbis_file/Hydrate-Kenny_Beltrey.wav")
