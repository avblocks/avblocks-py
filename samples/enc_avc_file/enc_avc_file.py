#!/usr/bin/env python3
"""
Encode YUV file to H.264/AVC.

This sample encodes a raw YUV video file to H.264/AVC format using AVBlocks.
"""
...
def create_output_socket(output_file: str) -> MediaSocket:
    """Create output socket for H.264 file."""
    socket = MediaSocket()
...
def main(input_file: str, output_file: str, fps: float, frame_size: str, 
    ...
    if not input_file or not output_file:
        ...
        if not output_file:
            output_file = os.path.join(script_dir, "../output/enc_avc_file/foreman_qcif.h264")
