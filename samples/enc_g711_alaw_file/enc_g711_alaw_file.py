#!/usr/bin/env python3
"""
Encode WAV file to G.711 A-law.

This sample encodes a WAV audio file to G.711 A-law format using AVBlocks.
"""
...
def create_output_socket(output_file: str) -> MediaSocket:
    """Create output socket for G.711 A-law WAV file."""
    socket = MediaSocket()
    ...
    asi.stream_type = StreamType.ALAW_PCM
...
@click.option('-o', '--output', 'output_file',
              help='Output WAV file (G.711 A-law)',
              type=click.Path())
