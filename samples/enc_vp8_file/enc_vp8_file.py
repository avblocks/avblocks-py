#!/usr/bin/env python3
"""
Encode YUV file to VP8/IVF.

This sample encodes a raw YUV video file to VP8 format in an IVF container using AVBlocks.
"""
...
def create_output_socket(output_file: str) -> MediaSocket:
    """Create output socket for VP8/IVF file."""
    socket = MediaSocket()
...
def main(input_file: str, output_file: str, fps: float, frame_size: str, 
    ...
    if not input_file or not output_file:
        ...
        if not output_file:
            output_file = os.path.join(script_dir, "../../output/enc_vp8_file/foreman_qcif.ivf")
