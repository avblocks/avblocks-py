#!/usr/bin/env python3
"""
Encode YUV file to H.265/HEVC using pull mode.

This sample encodes a raw YUV video file to H.265/HEVC format using the pull mode
...
def create_output_socket() -> MediaSocket:
    """Create output socket for H.265 encoding (no file)."""
    socket = MediaSocket()
...
def main(input_file: str, output_file: str, fps: float, frame_size: str, 
    ...
    if not input_file or not output_file:
        ...
        if not output_file:
            output_file = os.path.join(script_dir, "../../output/enc_hevc_pull/foreman_qcif.h265")
