#!/usr/bin/env python3
"""
Decode VP8/IVF file to YUV.

This sample decodes a VP8/IVF video file to raw YUV format using AVBlocks.
"""
...
def main(input_file: str, output_file: str):
    ...
    if not input_file or not output_file:
        ...
        if not input_file:
            input_file = os.path.join(script_dir, "../../assets/vid/foreman_qcif_vp8.ivf")
        if not output_file:
            output_file = os.path.join(script_dir, "../../output/dec_vp8_file/foreman_qcif.yuv")
