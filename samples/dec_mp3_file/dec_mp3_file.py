...
This sample decodes an MP3 audio file to a WAV file using AVBlocks.
"""
...
def main(input_file: str, output_file: str):
    ...
    if not input_file or not output_file:
        ...
        if not input_file:
            input_file = os.path.join(script_dir, "../../assets/aud/Hydrate-Kenny_Beltrey.mp3")
        if not output_file:
            output_file = os.path.join(script_dir, "../../output/dec_mp3_file/Hydrate-Kenny_Beltrey.wav")
